...
const Logo404Svg: React.FC<Props> = ({ className }) => {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="16.69%"
        >
          <stop offset="0%" stopColor="#7635dc"></stop>
          <stop offset="100%" stopColor="#7635dc" stopOpacity="0"></stop>
        </linearGradient>
        <linearGradient
          id="BG"
          x1="19.496%"
        ...
        >
          ...
          <stop offset="1" stopColor="#431A9E"></stop>
        </linearGradient>
      </defs>
      <path
        fill='url("#BG")'
